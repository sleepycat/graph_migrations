...
export async function redirectEdges(start, target, graphName, options){
  ...
  return await db.transaction({write: await allCollections(graphName)}, action, [start, target, graphName, options])
}
